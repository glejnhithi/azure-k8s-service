...
kubectl create deployment my-backend-rest-app --image=glejnhithi/kube-helloworld:1.0.0 
kubectl get deploy
...
kubectl create deployment my-frontend-nginx-app --image=glejnhithi/kube-frontend-nginx:1.0.0 
kubectl get deploy
